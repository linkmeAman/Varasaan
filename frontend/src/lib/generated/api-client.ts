...
export type PaymentCheckoutRequest = { tier: "essential" | "executor"; };
export type PaymentCheckoutResponse = { order_id: string; provider: string; provider_order_id: string; checkout_key_id?: string | null; tier: "essential" | "executor"; amount_paise: number; currency: string; status: string; };
...
export type CaseActivationReviewStatus = "not_requested" | "pending_review" | "approved" | "rejected";
...
export type CaseSummaryResponse = { id: string; owner_user_id: string; owner_name: string; owner_email: string; status: CaseStatus; activation_review_status: CaseActivationReviewStatus; activation_review_reason: string | null; activation_review_note: string | null; activation_review_requested_at: string | null; activation_review_updated_at: string | null; death_certificate_document_id?: string | null; death_certificate_version_id?: string | null; activated_at?: string | null; closed_at?: string | null; evidence_retention_expires_at?: string | null; created_at: string; updated_at: string; task_count: number; task_status_counts: CaseTaskStatusCounts; };
