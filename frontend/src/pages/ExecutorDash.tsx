      ...
      <header className="executor-header glass-panel">
        <div className="executor-header-content">
          ...
          <p className="executor-subtitle">
            Take this one step at a time. We've compiled the verified digital inventory. 
            Follow the guided checklist below to secure, recover, or responsibly close these endpoints.
          </p>
        </div>
        ...
        <div className="task-grid">
          ...
          <div className="task-card urgent glass-panel">
            ...
            <div className="task-footer">
              <Button size="sm" variant="primary">Generate Legal Packet</Button>
            </div>
          </div>
          ...
          <div className="task-card pending glass-panel">
            ...
            <p className="task-desc">
              Waiting on Google Trust & Safety review. Time elapsed: 12 days.
            </p>
            <div className="task-footer">
          ...
          {/* Card: Completed Action */}
           <div className="task-card completed glass-panel">
            ...
            <p className="task-desc">
              Successfully converted to a memorialized state.
            </p>
            <div className="task-footer">
               <span className="success-text"><FileCheck size={14} /> Completed</span>
            </div>
          </div>
